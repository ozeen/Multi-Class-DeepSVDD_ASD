...
def main(args):
    ...
    model_path = args.weight_dir #'weights/mel_only_weights_soft/best_checkpoint.pth.tar'
...
def run():
    ...
    params = utils.load_yaml(file_path='./config/config.yaml')
    ...
    parser.add_argument('--weight_dir', default='weights/mel_only_weights_soft/best_checkpoint.pth.tar', type=str)
